  ...
  return (
    <div className="wrapper">
      ...
      <p>
        ...
        Any of the information we collect from you may be used to help us run
        and operate the Website and Services.
      </p>
      <p>
      ...
      <p>
        {" "}
        The maintain the highest level of privacy and protecting your Personal
        Information to the full extent, we do not share your Personal
        Information with anyone and for any reason.
      </p>
      ...
      <p>
        ...
        and Services, please contact us. You must also be at least 16 years of
        age to consent to the processing of your Personal Information in your
        country (in some countries we may allow your parent or guardian to do so
        on your behalf).
      </p>
      ...
      <p>This document was last updated on May 4, 2021</p>
    </div>
  );
}
